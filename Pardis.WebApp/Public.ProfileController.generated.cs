...
namespace Pardis.WebApp.Areas.Public.Controllers
{
    public partial class ProfileController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ProfileController Actions { get { return MVC.Public.Profile; } }
        ...
        {
            public readonly string FillProfileCustommers = "FillProfileCustommers";
        ...
        {
            public const string FillProfileCustommers = "FillProfileCustommers";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ProfileController : Pardis.WebApp.Areas.Public.Controllers.ProfileController
    {
        public T4MVC_ProfileController() : base(Dummy.Instance) { }

        [NonAction]
        partial void FillProfileCustommersOverride(T4MVC_System_Web_Mvc_JsonResult callInfo);

        [NonAction]
        public override System.Web.Mvc.JsonResult FillProfileCustommers()
        {
            var callInfo = new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.FillProfileCustommers);
            FillProfileCustommersOverride(callInfo);
            return callInfo;
        }
