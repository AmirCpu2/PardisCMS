...
{
    public partial class ProductRelatedController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ProductRelatedController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ProductRelatedController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ProductRelatedController Actions { get { return MVC.SalesManagement.ProductRelated; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "SalesManagement";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "ProductRelated";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "ProductRelated";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string AddOrUpdate = "~/Areas/SalesManagement/Views/ProductRelated/AddOrUpdate.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ProductRelatedController : Pardis.WebApp.Areas.SalesManagement.Controllers.ProductRelatedController
    {
        public T4MVC_ProductRelatedController() : base(Dummy.Instance) { }
