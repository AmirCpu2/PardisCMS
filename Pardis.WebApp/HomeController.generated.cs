...
namespace Pardis.WebApp.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : Pardis.WebApp.Controllers.HomeController
    {
        ...
        [NonAction]
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Pardis.Product.BLL.ViewModel.AccountLogin entity);

        [NonAction]
        public override System.Web.Mvc.ActionResult Login(Pardis.Product.BLL.ViewModel.AccountLogin entity)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "entity", entity);
            LoginOverride(callInfo, entity);
            return callInfo;
        }
